...
public class MaxSalaryPlayersMenuController{
    ...
    public void initialize(MainApplication mainApp) {
        ...
        playerTable.setItems(FXCollections.observableArrayList(mainApp.getDatabase().MaxSalaryPlayers(mainApp.getMyClubName())));
