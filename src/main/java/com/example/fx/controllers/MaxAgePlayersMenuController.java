...
public class MaxAgePlayersMenuController{
    ...
    public void initialize(MainApplication mainApp) {
        ...
        playerTable.setItems(FXCollections.observableArrayList(mainApp.getDatabase().MaxAgePlayers(mainApp.getMyClubName())));
