...
public class SearchByNameMenuController {
    ...
    public void onSearchButtonClick(ActionEvent actionEvent) {
        String givenName = inputName.getText();
        Player player = mainApp.getDatabase().searchByName(givenName);
        if(givenName.isEmpty()){
            ...
            playerTable.setItems(FXCollections.observableArrayList(player));
        }
    }
