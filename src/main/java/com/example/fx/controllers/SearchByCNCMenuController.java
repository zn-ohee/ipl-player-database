...
public class SearchByCNCMenuController{
    ...
    public void onSearchButtonClick(ActionEvent actionEvent){
        String countryName = inputCountry.getText();
        String clubName = mainApp.getMyClubName();
        if(countryName.isEmpty()){
            playerTable.setItems(FXCollections.observableArrayList(mainApp.getDatabase().getPlayerList()));
        }
        else{
            playerTable.setItems(FXCollections.observableArrayList(mainApp.getDatabase().searchByCountryClub(countryName, clubName)));
        }
